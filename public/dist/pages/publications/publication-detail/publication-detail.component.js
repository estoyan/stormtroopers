...
var PublicationDetailComponent = (function () {
    function PublicationDetailComponent(_publicationService, _route, _localeStorageService) {
    ...
    PublicationDetailComponent.prototype.ngOnInit = function () {
        ...
        this._route.params
            ...
            .subscribe(function (p) { return _this.publication = p; });
    ...
    PublicationDetailComponent.prototype.addComment = function (content) {
        ...
        this._publicationService.addComment(publicationId, comment)
            .subscribe(function (_) { return _this.publication.comments.push(comment); });
    };
    PublicationDetailComponent = __decorate([
        ...
        __metadata('design:paramtypes', [publications_service_1.PublicatonsService, router_1.ActivatedRoute, local_storage_service_1.LocalStorageService])
