...
var MovieComponent = (function () {
    function MovieComponent(route, router, service) {
        this.route = route;
        this.router = router;
    ...
    MovieComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.params
            .switchMap(function (params) { return _this.service.getMovie(params['title']); })
            .subscribe(function (m) { return _this.movie = m; });
    };
